...
double GridData::interpolate( const vec3& pt )
{
	...
	if ( USE_CUBIC_INTERPOLATION ) {
		...
		//double atmp9  = (*this)(i-1, j+1, k-1);
		//double atmp13 = (*this)(i-1, j+2, k-1);
		double temp_1_5_9_13_Y1  = QERT(atmp1, atmp5, atmp9,  atmp13, fracty);	// Y @ X-1, Z-1

		//double atmp2  = (*this)(i  , j-1, k-1);
		//double atmp6  = (*this)(i  , j  , k-1);
		//double atmp10 = (*this)(i  , j+1, k-1);
		//double atmp14 = (*this)(i  , j+2, k-1);
		double temp_2_6_10_14_Y2 = QERT(atmp2, atmp6, atmp10, atmp14, fracty);	// Y @ X, Z-1

		//double atmp3  = (*this)(i+1, j-1, k-1);
		//double atmp7  = (*this)(i+1, j  , k-1);
		//double atmp11 = (*this)(i+1, j+1, k-1);
		//double atmp15 = (*this)(i+1, j+2, k-1);
		double temp_3_7_11_15_Y3 = QERT(atmp3, atmp7, atmp11, atmp15, fracty);	// Y @ X+1, Z-1

		//double atmp4  = (*this)(i+2, j-1, k-1);
		//double atmp8  = (*this)(i+2, j  , k-1);
		//double atmp12 = (*this)(i+2, j+1, k-1);
		//double atmp16 = (*this)(i+2, j+2, k-1);
		double temp_4_8_12_16_Y4 = QERT(atmp4, atmp8, atmp12, atmp16, fracty);	// Y @ X+2, Z-1

		// etc.

		double temp_17_21_25_29_Y5 = QERT(atmp17, atmp21, atmp25, atmp29, fracty);	// Y @ X-1, Z
		double temp_18_22_26_30_Y6 = QERT(atmp18, atmp22, atmp26, atmp30, fracty);	// Y @ X, Z
		double temp_19_23_27_31_Y7 = QERT(atmp19, atmp23, atmp27, atmp31, fracty);	// Y @ X+1, Z
		double temp_20_24_28_32_Y8 = QERT(atmp20, atmp24, atmp28, atmp32, fracty);	// Y @ X+2, Z

		double temp_33_37_41_45_Y9  = QERT(atmp33, atmp37, atmp41, atmp45, fracty);	// Y @ X-1, Z+1
		double temp_34_38_42_46_Y10 = QERT(atmp34, atmp38, atmp42, atmp46, fracty);	// Y @ X, Z+1
		double temp_35_39_43_47_Y11 = QERT(atmp35, atmp39, atmp43, atmp47, fracty);	// Y @ X+1, Z+1
		double temp_36_40_44_48_Y12 = QERT(atmp36, atmp40, atmp44, atmp48, fracty);	// Y @ X+2, Z+1

		double temp_49_53_57_61_Y13 = QERT(atmp49, atmp53, atmp57, atmp61, fracty);	// Y @ X-1, Z+2
		double temp_50_54_58_62_Y14 = QERT(atmp50, atmp54, atmp58, atmp62, fracty);	// Y @ X, Z+2
		double temp_51_55_59_63_Y15 = QERT(atmp51, atmp55, atmp59, atmp63, fracty);	// Y @ X+1, Z+2
		double temp_52_56_60_64_Y16 = QERT(atmp52, atmp56, atmp60, atmp64, fracty);	// Y @ X+2, Z+2

		double temp_Y1_Y2_Y3_Y4  = QERT(temp_1_5_9_13_Y1,     temp_2_6_10_14_Y2,    temp_3_7_11_15_Y3,    temp_4_8_12_16_Y4,    fractx);	// X @ Z-1
		double temp_Y5_Y6_Y7_Y8 = QERT(temp_17_21_25_29_Y5,  temp_18_22_26_30_Y6,  temp_19_23_27_31_Y7,  temp_20_24_28_32_Y8,  fractx);		// X @ Z
		double temp_Y9_Y10_Y11_Y12 = QERT(temp_33_37_41_45_Y9,  temp_34_38_42_46_Y10, temp_35_39_43_47_Y11, temp_36_40_44_48_Y12, fractx);	// X @ Z+1
		double temp_Y13_Y14_Y15_Y16 = QERT(temp_49_53_57_61_Y13, temp_50_54_58_62_Y14, temp_51_55_59_63_Y15, temp_52_56_60_64_Y16, fractx);	// X @ Z+2

		// Z
		return  QERT(temp_Y1_Y2_Y3_Y4, temp_Y5_Y6_Y7_Y8, temp_Y9_Y10_Y11_Y12, temp_Y13_Y14_Y15_Y16, fractz);
	}
	// linear interpolation
		...
		// Z
		return LERP(tmp1234, tmp5678, fractz);
	}
}
...
// QERT()
////////////////////////////////////////////////////
double GridData::QERT( double valueM1, double value, double valueP1, double valueP2, double t )
{
